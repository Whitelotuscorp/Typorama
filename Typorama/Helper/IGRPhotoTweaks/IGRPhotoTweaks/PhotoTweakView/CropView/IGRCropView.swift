...
public class IGRCropView: UIView {
    ...
    public var isResizeDisable : Bool = false
    
    //MARK: - Private VARs
    
    internal var upperLeft : IGRCropCornerView!
    internal var upperRight : IGRCropCornerView!
    internal var lowerLeft : IGRCropCornerView!
    internal var lowerRight : IGRCropCornerView!
    ...
    public func cornerView(isHide: Bool) {
        
        self.upperLeft.isHidden = isHide
        self.upperRight.isHidden = isHide
        self.lowerLeft.isHidden = isHide
        self.lowerRight.isHidden = isHide
    }
    ...
    fileprivate func setup() {
        ...
        upperLeft = IGRCropCornerView(cornerType: .upperLeft,
        ...
        upperRight = IGRCropCornerView(cornerType: .upperRight,
                                           lineWidth: cornerBorderWidth,
                                           lineLenght:cornerBorderLength)
        ...
        lowerRight = IGRCropCornerView(cornerType: .lowerRight,
                                           lineWidth: cornerBorderWidth,
                                           lineLenght:cornerBorderLength)
        ...
        lowerLeft = IGRCropCornerView(cornerType: .lowerLeft,
                                          lineWidth: cornerBorderWidth,
                                          lineLenght:cornerBorderLength)
